      ...
      {questions.map((item, index) => {
        ...
        return (
          <button
            ...
            className={`flex min-h-[52px] w-full items-center rounded-xl px-4 py-3 text-left outline-none transition-[box-shadow] duration-200 focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 sm:min-h-0 sm:rounded-2xl sm:px-5 sm:py-4 ${
              isActive
            ...
            <div className="flex w-full items-center justify-between gap-2">
              ...
              <span
                className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-lg font-medium text-white sm:h-14 sm:w-14 sm:rounded-xl sm:text-2xl md:h-16 md:w-16 md:text-3xl ${
                  isActive ? "bg-[#F1F5F9] !text-black dark:bg-[#123146] dark:!text-white" : "bg-[#123146] text-white dark:bg-white dark:!text-black"
                }`}
              >
                {isActive ? "−" : "+"}
              </span>
